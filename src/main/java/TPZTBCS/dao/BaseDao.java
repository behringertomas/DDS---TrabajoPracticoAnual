...
//    }
    ...
    private void handlerException(Exception ex) throws Exception{
    ...
    private void handlerPersistException(PersistenceException ex) throws Exception{
        if (ex.getCause() instanceof ConstraintViolationException){
            throw new Exception("CONSTRAIN VIOLATION EXCEPTION !!");
        }
    }
    ...
    //Rename
    public void deleteElement(Object o) throws Exception{
        try {
            begin();
            delete(o);
            commit();
