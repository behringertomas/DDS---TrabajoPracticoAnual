...
public class altaAccesorioAbrigoController extends MainController {
		    ...
		    public static void init() {
		        ...
		        Spark.get(Router.getAltaAccesorioabrigo(),altaAccesorioAbrigoController::load,engine);
		        Spark.post(Router.getAltaAccesorioabrigo(), altaAccesorioAbrigoController::crearPrenda, engine);
		        initModel();
		    }   
