...
//	    EntityManager entityManager = factory.createEntityManager();
    ...
    public static void loadUsuarios() throws Exception {
    	...
    	//	**** USUARIO STANDARD ****
		  ...
		  aroco.CrearGuardarropa(nombreGuardarropaDeAroco,50);
		  ...
		  aroco.construirPrenda("Accesorio","Reloj", "Oro", "Negro", aroco.getGuardarropa(nombreGuardarropaDeAroco), "");
	    ...
	    //	**** USUARIO PREMIUM ****
		  ...
		  jazul.construirPrenda("Accesorio","Pulsera", "Metal", "Negro", jazul.getGuardarropa(nombreGuardarropaDeJazul), "");
